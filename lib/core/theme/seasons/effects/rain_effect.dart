...
import 'package:chatify/core/theme/seasons/effects/rain_painter.dart';
      ...
      children: [
            ...
            return Positioned(
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: ChatifyColors.white.withAlpha((0.05 * 255).toInt()), shape: BoxShape.circle),
                ),
              ),
            );
          }).toList();
        ...
        ..._raindrops.map((raindrop) {
          return Positioned(
            left: raindrop.x,
            top: raindrop.y,
            child: Transform.rotate(angle: raindrop.angle, child: Image.asset(raindrop.asset, width: raindrop.radius, height: raindrop.radius)),
          );
        }),
      ],
    );
