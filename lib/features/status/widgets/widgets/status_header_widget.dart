...
class _StatusHeaderWidgetState extends State<StatusHeaderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isProfileImageLoading = widget.profileImageUrl == null;
                    ...
                    child: ClipRRect(
                      ...
                      child: isProfileImageLoading
                        ? ShimmerEffect(
                            ...
                            borderRadius: DeviceUtils.getScreenHeight(context) * .5,
                            angle: -0.16,
                          )
                          ...
                          : CachedNetworkImage(
                              ...
                              placeholder: (context, url) {
                                return ShimmerEffect(
                                  ...
                                  height: DeviceUtils.getScreenHeight(context) * .062,
                                  borderRadius:
                                  DeviceUtils.getScreenHeight(context) * .5,
                                  angle: -0.16,
                                );
                              },
  ...
  Widget _buildAvatarPlaceholder(BuildContext context) {
    final size = DeviceUtils.getScreenHeight(context) * .062;
