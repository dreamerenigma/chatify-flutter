            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  leading: Radio<int>(value: 1, activeColor: colorsController.getColor(colorsController.selectedColorScheme.value)),
                  onTap: () {
                    setState(() {
                      _selectedValue = 1;
                ...
                ListTile(
                  ...
                  leading: Radio<int>(value: 2, activeColor: colorsController.getColor(colorsController.selectedColorScheme.value)),
                  onTap: () {
                    setState(() {
                      _selectedValue = 2;
                      _saveSelectedValue(_selectedValue!);
                ...
                ListTile(
                  ...
                  leading: Radio<int>(value: 3, activeColor: colorsController.getColor(colorsController.selectedColorScheme.value)),
                  onTap: () {
                    setState(() {
                      _selectedValue = 3;
                      _saveSelectedValue(_selectedValue!);
