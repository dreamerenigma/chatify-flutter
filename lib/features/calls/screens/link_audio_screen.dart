                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text('Звонок Chatify', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: ChatifyColors.white)),
                                ),
                              ],
                            ),
                          ),
                      ...
                      const Text('Ожидание других участников', style: TextStyle(fontSize: 16, color: Colors.white70)),
                    ],
                  ),
                ),
              ),
                    ...
                    child: Row(
                      ...
                      children: [
                        const CircleAvatar(
                          backgroundColor: ChatifyColors.darkerGrey,
                          radius: 25,
                          child: Icon(Icons.more_horiz_rounded, color: ChatifyColors.white),
                        ),
                        const CircleAvatar(
                          backgroundColor: ChatifyColors.darkerGrey,
                          radius: 25,
                          child: Icon(Icons.volume_up, color: ChatifyColors.white),
                        ),
                        const CircleAvatar(
                          backgroundColor: ChatifyColors.darkerGrey,
                          radius: 25,
                          child: Icon(Icons.mic, color: ChatifyColors.white),
                        ),
                        InkWell(
                          onTap: () async {
