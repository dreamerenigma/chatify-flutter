    ...
    builder: (BuildContext context) {
      return StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) {
          return AlertDialog(
            title: Text('${S.of(context).deleteAllChats}?', style: TextStyle(fontSize: ChatifySizes.fontSizeMg, fontWeight: FontWeight.w400)),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(S.of(context).deleteMediaFilesReceivedChats, style: TextStyle(color: ChatifyColors.darkGrey)),
                        ),
                      ],
                    ),
                  ),
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                child: Text(S.of(context).deleteChats, style: TextStyle(fontSize: ChatifySizes.fontSizeMd)),
              ),
            ],
          );
        },
