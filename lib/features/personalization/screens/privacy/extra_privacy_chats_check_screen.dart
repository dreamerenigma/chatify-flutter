                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Дополнительная конфиденциальность для ваших чатов', style: TextStyle(fontSize: ChatifySizes.fontSizeMg, fontWeight: FontWeight.w400), textAlign: TextAlign.center),
                    ),
                    const SizedBox(height: 20),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 25, vertical: 8),
                      child: Text('Используйте функции конфиденциальности дял защиты и ограничения доступа к своим сообщениям и медиафайлам.', style: TextStyle(fontSize: ChatifySizes.fontSizeSm, color: ChatifyColors.darkGrey), textAlign: TextAlign.center),
                    ),
                    const SizedBox(height: 10),
                    _buildCheckPrivacy(
                      icon: Icons.timer,
                      text: 'Автоматический таймер сообщений',
                    ...
                    _buildCheckPrivacy(
                      ...
                      text: 'Резервное копирование со сквозным шифрованием',
                      subtitle: 'Включите шифрование своей резервной копиии, чтобы никто, включая сотрудников Input Studios или Chatify, не смог получчить к ней доступ.',
                      onTap: () {
                        Navigator.push(
                          context,
