            ...
            Column(
              ...
              children: [
                ...
                SettingsMenuTile(
                  ...
                  backgroundColor: ChatifyColors.transparent,
                  noRoundedCorners: true,
                  onTap: () => Navigator.push(context, createPageRoute(const SupportScreen(title: 'Отправить отзыв', showText: false, showReadMoreText: true, showCompactButtonOnly: true))),
                ),
                SettingsMenuTile(
