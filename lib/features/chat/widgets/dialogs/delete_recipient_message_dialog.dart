              ...
              children: [
                Padding(
                  ...
                  child: TextButton(
                    ...
                    child: Text(S.of(context).deleteFromAll, style: TextStyle(fontSize: ChatifySizes.fontSizeMd, fontWeight: FontWeight.w400)),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: TextButton(
                    ...
                    child: Text(S.of(context).deleteFromMe, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                  ),
                ),
                const SizedBox(height: 8),
                Padding(
