...
class ContactsSendCard extends StatefulWidget {
  ...
  @override
  State<ContactsSendCard> createState() => ContactsSendCardState();
}

class ContactsSendCardState extends State<ContactsSendCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      margin: EdgeInsets.symmetric(horizontal: DeviceUtils.getScreenWidth(context) * .04, vertical: 4),
                  ...
                  InkWell(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        const CircleAvatar(backgroundColor: Colors.blue, foregroundColor: Colors.white, child: Icon(CupertinoIcons.person)),
                      ),
                    ),
                  ),
